package com.yiwo.fuzhoudian.services;
...
import com.yiwo.fuzhoudian.utils.NougatUntil;
...
//                }
    ...
    public void createNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setSmallIcon(R.mipmap.ic_launcher_round).setNumber(3);
        } else {
            notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
            notificationCompat = new NotificationCompat.Builder(getApplicationContext());
            notificationCompat.setAutoCancel(false);
            notificationCompat.setSmallIcon(R.mipmap.ic_launcher_round);
