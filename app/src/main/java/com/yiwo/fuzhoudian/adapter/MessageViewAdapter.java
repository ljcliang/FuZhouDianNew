...
import com.yiwo.fuzhoudian.model.MessageViewModel;
//import com.yiwo.fuzhoudian.pages.MessageCenterDetailsActivity;
...
public class MessageViewAdapter extends RecyclerView.Adapter<MessageViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if(!StringUtils.isEmpty(data.get(position).getMes_pic()))
            Glide.with(context).load(data.get(position).getMes_pic()).into(holder.picIv);
