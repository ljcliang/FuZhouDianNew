    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cityBean != null) {
            ...
            if (id == null || id.equals("null") || StringUtils.isEmpty(id)) {
                holder.rl.setBackgroundColor(context.getResources().getColor(R.color.color_white_ffffff));
                holder.tv.setTextColor(context.getResources().getColor(R.color.color_black_333333));
            } else {
                if (cityBean.getId().equals("-1")) {
                    holder.rl.setBackgroundColor(context.getResources().getColor(R.color.color_f8f8f8));
                    holder.tv.setTextColor(context.getResources().getColor(R.color.color_black_333333));
                } else {
                    holder.rl.setBackgroundColor(context.getResources().getColor(R.color.color_white_ffffff));
                    holder.tv.setTextColor(context.getResources().getColor(R.color.color_black_333333));
