...
import com.yiwo.fuzhoudian.model.UserRealNameInfoModel;
                        ...
                        try {
                            ...
                            if (jsonObject.getInt("code") == 200) {
                                ...
                                if (model.getObj().getUsercodeok().equals("0") || model.getObj().getUsercodeok().equals("3")) {
                                    ...
                                    Glide.with(RealNameActivity.this).load(model.getObj().getUsercode()).into(ivId1);
                                    Glide.with(RealNameActivity.this).load(model.getObj().getUsercodeback()).into(ivId2);
...
//                        .setSelected(selected) // 把已选的图片传入默认选中。
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE && data != null) {
            ...
            Glide.with(RealNameActivity.this).load("file://" + scList.get(0)).into(ivId1);
            ivId1.setVisibility(View.VISIBLE);
        ...
        if (requestCode == REQUEST_CODE1 && data != null) {
            ...
            Glide.with(RealNameActivity.this).load("file://" + scList.get(0)).into(ivId2);
            ivId2.setVisibility(View.VISIBLE);
