...
public class MyClipImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        isCameraImage = false;
        List<String> images = getIntent().getStringArrayListExtra("paths");
...
//        }
    ...
    private void confirm(Bitmap bitmap) {
        ...
        if (StringUtils.isNotEmptyString(imagePath)) {
            ...
            intent.putStringArrayListExtra("paths",selectImages);
            intent.setClass(this, CreateYouJiAddInfoActivity.class);
    ...
    public static void openActivity(Activity context, int requestCode, boolean isViewImage,
        ...
        Intent intent = new Intent(context, com.donkingliang.imageselector.ClipImageActivity.class);
    ...
    public static void openActivity(Fragment fragment, int requestCode, boolean isViewImage,
                                    boolean useCamera, ArrayList<String> selected) {
        Intent intent = new Intent(fragment.getContext(), com.donkingliang.imageselector.ClipImageActivity.class);
        intent.putExtras(dataPackages(requestCode, isViewImage, useCamera, selected));
    ...
    public static void openActivity(android.app.Fragment fragment, int requestCode, boolean isViewImage,
                                    boolean useCamera, ArrayList<String> selected) {
        Intent intent = new Intent(fragment.getActivity(), com.donkingliang.imageselector.ClipImageActivity.class);
        intent.putExtras(dataPackages(requestCode, isViewImage, useCamera, selected));
        fragment.startActivityForResult(intent, requestCode);
    }
