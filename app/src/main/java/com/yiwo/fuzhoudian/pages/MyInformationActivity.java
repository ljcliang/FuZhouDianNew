...
import com.yiwo.fuzhoudian.utils.GetJsonDataUtil;
...
//                                }
    ...
    @OnClick({R.id.activity_my_information_rl_back, R.id.activity_my_information_rl_location,
            R.id.activity_my_information_rl_register_time, R.id.activity_my_information_rl_real_name, R.id.activity_my_information_rl_save,
                            ...
                            .request(new ACallback<String>() {
                                ...
                                public void onSuccess(String data) {
                                    try {
                                        ...
                                        if (jsonObject.getInt("code") == 200) {
                                            Toast.makeText(MyInformationActivity.this, "头像上传成功", Toast.LENGTH_SHORT).show();
                                            Glide.with(MyInformationActivity.this).load("file://" + list.get(0)).into(ivAvatar);
                                        }
                                    } catch (JSONException e) {
                                        e.printStackTrace();
                                    }
