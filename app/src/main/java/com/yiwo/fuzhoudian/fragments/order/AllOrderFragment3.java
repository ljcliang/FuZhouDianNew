...
public class AllOrderFragment3 extends BaseFragment {
    ...
    public static AllOrderFragment3 newInstance(int status){//status  不传或传100 全部     传1待处理  2已处理   3已完成   4退款
        Bundle args = new Bundle();
        args.putString(STATUS, status+"");
        AllOrderFragment3 fragment = new AllOrderFragment3();
