...
import com.yiwo.fuzhoudian.pages.RegisterActivity;
...
//                    Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); // 设置前景色为
//        }
        activity.getCode_btn().setTextColor(activity.getResources().getColor(R.color.colorPrimary));
...
//        activity.getCode_btn().setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.white_60white_box));
    ...
    public void onFinish() {
        ...
        // 设置字体背景色
        msp.setSpan(new ForegroundColorSpan(activity
                        .getResources().getColor(R.color.color_white_ffffff)), 0, 0,
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); // 设置前景色为
